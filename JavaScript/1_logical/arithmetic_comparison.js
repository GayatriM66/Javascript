...
//comparison operator
//<, >, <= , >= , !=, ==, ===, !===
// == 2 operator (check for value)
// === 3 operator (check for value and type)
...
// let numberOfTickets1 = 11

// if (numberOfTickets1 <= 5) {
//     console.log("5% discount")
// }
// else if (numberOfTickets1 > 5 && numberOfTickets1 <= 10) {
//     console.log("10% discount")
// }
// else {
...
//-----<,>,<=,>=,==,===,!=,!==          (= and ! alone are not comaprison operators)
